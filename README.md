# 06-db-03-mysql-hw - «MySQL» - Дрибноход давид
...
```
```bash
root@debian10-2:~/docker/mysql$ docker-compose  ps
...
```bash
root@debian10-2:~/docker/mysql$ docker exec -it mysql-mysql-1 bash
root@dc2f87d6ad7b:/# mysql -u root -p test_db < /data/backup/mysql/test_dump.sql
Enter password:
```
